...
// settings
int delayBetweenPulsesFrom = 40; // in ms, first value on range of for random pulses delay, for example 20
int delayBetweenPulsesTo = 100; // in ms, last value on range of for random pulses delay, for example 40
int pulseDuration = 20; // in ms, for example 20
boolean continousStimulation = true;// stimulation not dependent of the behavoiur arduino
...
void loop() {
  if  (continousStimulation == true) {
    ...
    delayBetweenPulses = random(delayBetweenPulsesFrom,delayBetweenPulsesTo); // random number as set above
