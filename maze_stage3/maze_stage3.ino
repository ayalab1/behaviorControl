...
int servoclose_1 = 90;
int servoopen_2 = 180;
int servoclose_2 = 105;
int servoopen_3 = 180;
int servoclose_3 = 110;
int servoopen_4 = 180;
...
unsigned long PUMP_OPEN_TIME1 = 100;// 35-40
unsigned long PUMP_OPEN_TIME2 = 120;// 35-40
unsigned long PUMP_OPEN_TIME3 = 120;// 35-40
...
void loop()
{
    ...
    if (water_open_1 && millis() - Water_1 >= PUMP_OPEN_TIME1)
    {
        digitalWrite(pump_1, LOW);
        water_open_1 = false;
    ...
    if (water_open_2 && millis() - Water_2 >= PUMP_OPEN_TIME2)
    {
        digitalWrite(pump_2, LOW);
        water_open_2 = false;
        analogWrite(TTLperm, round(0));
    ...
    if (water_open_3 && millis() - Water_3 >= PUMP_OPEN_TIME3)
    {
        digitalWrite(pump_3, LOW);
        water_open_3 = false;
        analogWrite(TTLperm, round(0));
